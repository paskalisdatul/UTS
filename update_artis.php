...
<html data-bs-theme="light" lang="en-US" dir="ltr">
  ...
  <?php
    ...
    if (isset($_GET['id_artis'])) {
        ...
        $sql="select * from artis where id_artis=$id_artis";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $id_artis=htmlspecialchars($_POST["id_artis"]);
        $namaartis=($_POST["namaartis"]);
      ...
      <div class="bg-white">
        <div class="content">
          <nav class="navbar navbar-expand-lg py-1" id="navbar-top" data-navbar-soft-on-scroll="data-navbar-soft-on-scroll">
            <div class="container"><a class="navbar-brand me-lg-auto cursor-pointer" href="">Ubah Artis</a>
            </div>
          </nav>
            ...
            <div class="mb-9 mb-lg-10 mb-xxl-11 text-center text-lg-start mt-9">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                    <div class="row g-4 g-lg-6 g-xl-7 mb-6 mb-lg-7 mb-xl-10 align-items-center">
                        <div class="mb-3 row">
                            <label for="namaartis" class="col-sm-2 col-form-label">Nama Artis</label>
                            <div class="col-sm-10">
                            <input type="text" class="form-control" name="namaartis" value="<?php echo $data["namaartis"]; ?>">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <div class="col-sm-10">
                            <input type="hidden" name="id_artis" value="<?php echo $data['id_artis']; ?>" />
