...
<html data-bs-theme="light" lang="en-US" dir="ltr">
  ...
  <?php
    ...
    if (isset($_GET['id_daftarmusik'])) {
        $id_daftarmusik=($_GET["id_daftarmusik"]);

        $sql="select * from daftarmusik where id_daftarmusik=$id_daftarmusik";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $id_daftarmusik=htmlspecialchars($_POST["id_daftarmusik"]);
        $judul=($_POST["judul"]);
        $penyanyi=($_POST["penyanyi"]);
        $tahun=($_POST["tahun"]);
    
        //Query update data pada tabel anggota
        $sql="update daftarmusik set
			judul='$judul',
			penyanyi='$penyanyi',
			tahun='$tahun'
			where id_daftarmusik=$id_daftarmusik";
            ...
            <div class="mb-9 mb-lg-10 mb-xxl-11 text-center text-lg-start mt-9">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                    <div class="row g-4 g-lg-6 g-xl-7 mb-6 mb-lg-7 mb-xl-10 align-items-center">
                        ...
                        <div class="mb-3 row">
                            <div class="col-sm-10">
                            <input type="hidden" name="id_daftarmusik" value="<?php echo $data['id_daftarmusik']; ?>" />
