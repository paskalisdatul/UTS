...
<html data-bs-theme="light" lang="en-US" dir="ltr">
  ...
  <?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql="insert into favorit (judul,penyanyi,tahun) values
		('$judul','$penyanyi','$tahun')";
      ...
      <div class="bg-white">
        <div class="content">
          <nav class="navbar navbar-expand-lg py-1" id="navbar-top" data-navbar-soft-on-scroll="data-navbar-soft-on-scroll">
            <div class="container"><a class="navbar-brand me-lg-auto cursor-pointer" href="">Tambah Musik Favorit</a>
            </div>
          </nav>
              ...
              <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
                <div class="row g-4 g-lg-6 g-xl-7 mb-6 mb-lg-7 mb-xl-10 align-items-center">
                  <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="judul" placeholder="Masukan Judul Lagu">
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label for="penyanyi" class="col-sm-2 col-form-label">penyanyi</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="penyanyi" placeholder="Masukan Nama Penyanyi">
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <label for="tahun" class="col-sm-2 col-form-label">Tahun Rilis</label>
                    <div class="col-sm-10">
                      <input type="date" class="form-control" name="tahun" placeholder="Masukan Tahun Rilis">
                    </div>
                  </div>
                  <div class="mb-3 row">
                    <div class="col-sm-10">
